...
function CompanyRequests() {
  ...
  const fetchRequests = async () => {
    try {
      ...
      // Call the get_filtered_requests function
      const { data: requests, error } = await supabase.rpc(
        ...
        { 
          ...
          p_delegation: 'MADRID', // Always filter by MADRID
  ...
  const handleExportExcel = () => {
    ...
    // Generate filename with delegation and work center
    const filename = `solicitudes_MADRID_${selectedWorkCenter?.replace(/\s+/g, '_') || 'todos'}_${new Date().toISOString().split('T')[0]}.xlsx`;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {workCenterOptions.map(center => (
                <button
                  ...
                  className="p-4 bg-white border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors"
                >
                  {center}
                </button>
              ))}
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Delegación: MADRID</p>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {request.request_status === 'pending' && (
                        <div className="flex gap-2">
                          ...
                          <button
                            onClick={() => handleUpdateStatus(request.request_id, 
